...
from .objects import KeycloakGroup
...
class KeycloakRequester:
    ...
    def get_access_token(self):
        ...
        credentials_encoded = self.convertToBase64(
    ...
    def query(self, url):
        ...
        response = requests.get(
            f"{self.base_url}{url}", headers=headers, verify=self.cacerts
        )
...
class KubespawnerKeycloak:
    ...
    def __init__(
        ...
        groups_claim="realm_groups",
        parent_group_name: str = "jupyter-workspaces",
    ):
        """
        ...
        """
        self.requester: KeycloakRequester = KeycloakRequester(
            base_url, token_url, client_id, client_secret, cacerts=cacerts
        )
    ...
    def get_permitted_workspaces(self):
        ...
        for group_name in self.groups:
            ...
            workspace_dict = group.to_workspace_dict(
                kubespawner_override=self.environments_config.get(
